# I found a bug in this sample code given by Numenta in line number 64.  i corrected itand when 
#to Numenta github page to report it , I saw it was already reported some days ago .ssss
